...
">
			<h1>FACULTIES</h1>
			<p>AIET in its endeavour to excel in teaching,research and service offers bachelor of engineering and master of business administration</p>			<div class="row pt-3 pb-3">
				<div class="col-lg-3 col-md-3 col-sm-12 col-10 m-auto">
					<div class="card card-margin">
						...
						<div class="card-body">
							<h5 class="card-title">Faculty of Civil & Mechanical</h5>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-12 col-10 m-auto">
					<div class="card card-margin">
						...
						<div class="card-body">
							<h5 class="card-title">Faculty of Electronics & Communication</h5>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-12 col-10 m-auto">
